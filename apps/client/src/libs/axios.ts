...
export const axios = _axios.create({
  baseURL: import.meta.env.VITE_PUBLIC_URL, // Use VITE_PUBLIC_URL from .env
  withCredentials: true,
});

export const aiChatAxios = _axios.create({
  baseURL: import.meta.env.VITE_AI_API_RRL, // Use VITE_PUBLIC_URL from .env
  withCredentials: true,
});
