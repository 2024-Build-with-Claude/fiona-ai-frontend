...
import { Book, EnvelopeSimpleOpen, HandHeart } from "@phosphor-icons/react";
import {
  buttonVariants,
  Card,
  CardContent,
  ...
  <Card className="space-y-4 bg-info text-info-foreground">
    <CardContent className="space-y-2">
      ...
      <CardDescription className="space-y-2">
        <Trans>
          <p>
            I built Resume Wizard mostly by myself during my spare time, with a lot of help from
    ...
    <CardFooter>
      ...
      >
        ...
        <span className="line-clamp-1">{t`Donate to Resume Wizard`}</span>
      </a>
    </CardFooter>
  </Card>
);
  ...
  <Card className="space-y-4">
    <CardContent className="space-y-2">
      ...
      <CardDescription className="space-y-2">
        <Trans>
          <p>
            The community has spent a lot of time writing the documentation for Resume Wizard, and
