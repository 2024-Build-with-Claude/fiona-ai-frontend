      ...
      <div className="prose prose-sm prose-zinc max-w-full dark:prose-invert">
        <p>
          <Trans>
            ...
            to disable the AI features in Resume Wizard altogether, you can simply remove the key
            from your settings.
          </Trans>
        </p>
      </div>
      ...
      <Alert variant="warning">
        <div className="prose prose-neutral max-w-full text-xs leading-relaxed text-primary dark:prose-invert">
          <Trans>
            ...
            outlined by OpenAI. Please note that Resume Wizard bears no responsibility for any
