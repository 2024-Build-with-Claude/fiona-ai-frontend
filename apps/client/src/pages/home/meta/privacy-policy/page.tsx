      ...
      <ol>
        <li>
          ...
          <p>
            ...
            you provide when using our web application. By accessing or using Resume Wizard, you
        ...
        <li>
          ...
          <p>
            Resume Wizard is committed to ensuring the security of your data. Our application and
        ...
        <li>
          ...
          <p>
            ...
            contact us at <code>lj@fuhai.org</code>.
          </p>
        </li>
      </ol>
    </section>
